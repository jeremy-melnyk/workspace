...
public class FlightServerImpl implements FlightServer{
	...
	public String bookFlight(String firstName, String lastName, String address, String phoneNumber, String destination,
		...
		logger.log(city.toString(), "BOOK_FLIGHT_FAIL", "Either no Flight Records match Date: " + date + ", there are no available seats for " + flightClassValue + ", there is no flight to the chose destination: " + destination);
